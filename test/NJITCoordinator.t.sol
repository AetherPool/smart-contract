...
//     function _createMockSwapDelta(uint128 swapAmount, bool zeroForOne) internal pure returns (BalanceDelta) {
//         if (zeroForOne) {
//             return toBalanceDelta(-int128(swapAmount), int128(swapAmount * 99 / 100));
//         } else {
//             return toBalanceDelta(int128(swapAmount * 99 / 100), -int128(swapAmount));
//         }
//     }
...
//                 console.log("  LP %s profits: %s token0, %s token1", lp, (profit0 * 1e18), (profit1 * 1e18));
//                 assertTrue(profit0 > 0 || profit1 > 0, "LP should have accrued profits from fees");
//             }
//         }
...
//             BalanceDelta mockDelta = _createMockSwapDelta(LARGE_SWAP, true);
//             uint24 mockFee = 3000;
